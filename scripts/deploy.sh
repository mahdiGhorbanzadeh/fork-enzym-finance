...
contracts=("Dispatcher" "UintListRegistry" "AddressListRegistry" "ExternalPositionFactory" "FundDeployer" "GlobalConfigLib" "FeeManager" "PolicyManager" "IntegrationManager")
